...
<!--                <div class="pull-right">
            ...
            <div class="panel-body">
                ...
                <form action="../Forum/newtopichandler.php" method="post">
                <div class="form-group  col-lg-12">
                                <div class="col-sm-4 col-lg-2 col-md-2 col-xs-4">
                                    <label class="control-label"id="label">Subject</label>
                                </div>
                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-8">
                                    <input name="subject" id="subject" type="text" class="form-control" placeholder=" " data-toggle="tooltip" required title="Enter MRP!">
                                </div>
               ...
               <div class="form-group col-lg-12">
                                <div class="col-sm-4 col-lg-2 col-md-2 col-xs-4">
                                    <label class="control-label"id="label">Category</label>
                                </div>
                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-8">
                                    <?php
                                        $_SESSION["forum_cat"] = $_GET["id"];
                                        echo $_SESSION["forum_cat"];

                                    ?>
                                </div>

               </div>
                <h3 style="text-align: left">Post Your Question</h3>
                <div class="form-group  col-lg-12">
                                <div class="col-sm-4 col-lg-2 col-md-2 col-xs-4">
                                    <label class="control-label"id="label">Question</label>
                                </div>
                                <div class="col-sm-4 col-lg-4 col-md-4 col-xs-8">
<!--                                    <input name="subject" id="mrp" type="text" class="form-control" placeholder=" " data-toggle="tooltip" required title="Enter MRP!">-->
                                    <textarea name="question" class="form-control" rows="10" cols="8" id="comment"></textarea>
                                </div>
                ...
                <div class="form-group  col-lg-12">
                                ...
                                <div class=" col-lg-offset-2 col-sm-4 col-lg-4 col-md-4 col-xs-8">
                                    <input name="submit" id="submit" type="submit" value="submit" class="btn btn-success" placeholder=" " data-toggle="tooltip" required title="Enter MRP!">
