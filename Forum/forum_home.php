...
<html>
    <head>
        ...
        <title>Forum | Sai Enterprise</title>
        <link href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css" rel="stylesheet">
        <script type="text/javascript" src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.3/jquery.min.js"></script>
        <script type="text/javascript" src="http://tristanedwards.me/u/SweetAlert//lib/sweet-alert.min.js"></script>
        ...
        <script type="text/javascript">
            ...
            {
                window.location.href="http://localhost/SaiEnterpriseWebsite/Forum/CreateTopic.php?id="+forumid;
            }
            function ViewTopic(forumid)
            {
                window.location.href="http://localhost/SaiEnterpriseWebsite/Forum/ViewTopic.php?id="+forumid;
            }
        </script>
<style>
                    #___gcse_0
...
swal({
title: 'Topic Added!',
text: 'You added a new topic in this forum community!',
type: 'success',
confirmButtonText: 'Cool'
});
});</script>";
        //echo "<script>swal('Topic Added!', 'You added a new topic in this forum community!', 'success');</script>";
    }
...
<!--                            <div id="myCarousel" class="carousel slide" data-ride="carousel">
                ...
                <li><a href="forum_home.php" style="color: #428bca;"><b>Forum</b></a></li>
...
<!--                <thead>
                ...
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">No. of Topics</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php
                            ...
                            $forum = new Forum();
                            $result=$forum->getForumCategory();
                            
                            while($row=  mysqli_fetch_array($result,MYSQLI_BOTH))
                            {
                                $forumid=$row["forum_cat_id"];
                                echo "<tr>
                        <td style='text-align: center;'><h4>".$row["forum_cat_name"]."</h4><h5>".$row["forum_cat_desc"]."</h5></td>";
                                $forumTopics = new Forum();
                            $result2=$forumTopics->getNoOfTopics($row["forum_cat_id"]);
                            if(mysqli_num_rows($result2) > 0)
                            {
                                echo "  <td style='text-align: center;'>".mysqli_num_rows($result2)."</td>";
                            }
                            else
                            {
                                echo "  <td style='text-align: center;'>No topics yet</td>";
                            }
                      
                      echo "  <td style='text-align: center;'><button class='btn btn-primary' onclick=CreateTopic($forumid)>Create a Topic</button> </td>";
                      echo "  <td style='text-align: center;'><button class='btn btn-success' onclick='ViewTopic($forumid)'>View Topics</button> </td>";
                  echo "  </tr>";
                            }
