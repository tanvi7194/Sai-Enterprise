...
<!--    <div class="row">
        <div class="panel panel-primary filterable">
            <div class="panel-heading">
                <h3 class="panel-title"><?php //echo $topicname;?></h3>
                </div>
            <table class="table">
                <thead>
                    <tr>
                ...
                <tbody>-->
<?php echo "<h3 style='text-align: center;'>Topic Name: ".$topicnm."</h3>";?>
                <?php
                }
            $postby = new Forum();

            $frm = new Forum();
            $posts = $frm->getPosts($tid);
            $i=1;
            while($row2=  mysqli_fetch_array($posts,MYSQLI_BOTH))
            {
                
                        $by = $postby->getTopicBy($row2["post_by"]);
...
<div>
        <form action="InsertPostHandler.php" method="post">
...
<!--                                    <input name="subject" id="mrp" type="text" class="form-control" placeholder=" " data-toggle="tooltip" required title="Enter MRP!">-->
                                    <textarea name="post" class="form-control" rows="10" cols="8" id="comment"></textarea>
                                </div>
            </div>
            <div class="form-group  col-lg-12">

                                <div class=" col-lg-offset-2 col-sm-4 col-lg-4 col-md-4 col-xs-8">
                                    <input name="submit" id="submit" type="submit" value="submit" class="btn btn-success" placeholder=" " data-toggle="tooltip" required">
