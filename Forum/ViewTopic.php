...
<html>
    <head>
        ...
        function viewPosts(topicid)
            {
                window.location.href="http://localhost/SaiEnterpriseWebsite/Forum/ViewPost.php?id="+topicid;
            }
       </script>
        <style>
                    #___gcse_0
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th style="text-align: center;">Topic Posted By</th>
                        <th style="text-align: center;">No. of Replies</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    ...
                    $res = $newforum->getTopics($fid);
                    while($row=  mysqli_fetch_array($res,MYSQLI_BOTH))
                    {
                        $tid = $row["forum_topic_id"];
                        $no = $f->getNoOfPosts($row["forum_topic_id"]);
                        $user = $nf->getTopicBy($row["topic_by"]);
                        echo "<tr>";
                        echo "<td style='text-align: center;'>".$i."</td>";
                        echo "<td style='text-align: center;'><u>".$row["subject"]."</u></td>";
                        echo "<td style='text-align: center;'>".$user."</td>";
                        if(mysqli_num_rows($no) > 0)
                        {
                            echo "<td style='text-align: center;'>".mysqli_num_rows($no)."</td>";
                        }
                        else
                        {
                            echo "<td style='text-align: center;'>No Posts yet</td>";
                        }
                        echo "<td style='text-align: center;'><button class='btn btn-primary' onclick='viewPosts($tid);'>View</button>";
                        $i++;
                    }
                    ?>
                </tbody>
