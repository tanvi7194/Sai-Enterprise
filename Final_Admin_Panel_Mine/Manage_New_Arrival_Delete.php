...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>Sai Enterprise | Manage New Arrival</title>
...
<!--		<link href="plugins/chartist/chartist.min.css" rel="stylesheet">  		 HTML5 shim and Respond.js IE8 support of HTML5 elements and media queries -->
		<!--[if lt IE 9]>
    ...
    {
        window.location.href="Delete_New_Arrival_Handler.php?pid="+p_id;
    }
	...
	<div class="col-xs-12 col-sm-12">
		<div class="box">
			...
			<div class="box-content">
				<h4 class="page-header">Delete New Arrival</h4>
...
<div class="panel panel-default">
 ...
 require_once 'connection_file.php';
       $sql=  mysqli_query($con,"SELECT * FROM se_new_arrivals");
if(mysqli_num_rows($sql) > 0)
        {
            while ($newarr=mysqli_fetch_array($sql,MYSQLI_BOTH)) {
                $id=$newarr['product_id'];
                
                $query = mysqli_query($con,"Select * from se_product WHERE product_id='$id'");
                 while($data = mysqli_fetch_array($query,MYSQLI_BOTH)){
                     $img = $data["product_image_path_1"];
                     $str = "<tr><td>".$data['product_id']."</td><td>".$data['product_name']."</td><td><img src=$img height=100 width=100></td><td>".$data['product_selling_price']."</td>";
                     
                     $str.="<td><input type='button' class='btn btn-primary' value='Delete' onclick=delpro(".$data['product_id'].")></td></tr>";
                     echo $str;
                 }
            }
        }
