		...
		<!--webfonts-->
                ...
                function getCity(id)
                {
                    if (window.XMLHttpRequest) {
                      ...
                      xmlhttp.open("GET","Get_Cities_AJAX.php?id="+id,true);
                      xmlhttp.send();
                }
					...
					<div  class="wrap">
						  <div class="Regisration">
						  	<div class="Regisration-head">
						    	<h2><span></span>Billing Address</h2>
						 	 </div>
                                                      <form action="BillAddress_handler.php" method="post">
                                                          <label style="color: white;">Address Line 1:</label><input type="text" placeholder="address line 1" name="add1" id="add1"><br>
                                                          <label style="color: white;">Address Line 2:</label><input type="text" placeholder="address line 2" name="add2" id="add2"><br>
                                                          <label style="color: white;">State:</label><br>
                                                          <?php
                                    ...
                                    while ($row = mysqli_fetch_array($result,MYSQLI_BOTH)) {
                                        ...
                                        echo "<option value='$i'>$row[0]</option>";
                                                                ...
                                                                <div id="cities"></div>
                                                          <label style="color: white;">Country:</label><input type="text" placeholder="Country" name="country" id="country"><br>
                                                          <label style="color: white;">Zip-code:</label><input type="number" placeholder="Zip-code" name="zipcode" id="zipcode"><br>
                                                          
                                                                
                                                                <br>
                                                                <label style="color: white;"><input type="checkbox" id="same" name="same"><i></i>Shipping Address same as above</label><br>
                                                                
								 <div class="Remember-me">


								<div class="submit">
                                                                    <input id="submit" type="submit" value="Save and Next" >
                        ...
                        $('#same').click(function(){
                          ...
                          {
                            $('#submit').prop('value','Save and Next');
                          }
                        });
//                         $('#same').click(function(){
//                          if(!($(this).prop("checked",true))) {
