...
//                        }
  ...
  xmlhttp.open("GET","forgotPassHandler.php",true);
  xmlhttp.send();
}

function goBack()
{
    window.location.replace("http://localhost/LoungeDeJewelWebsite/login.php");
}

function changePassSec() {
//alert(value);
  if (window.XMLHttpRequest) {
    // code for IE7+, Firefox, Chrome, Opera, Safari
    xmlhttp=new XMLHttpRequest();
...
//                        }
  ...
  xmlhttp.open("GET","forgotPassSecHandler.php",true);
  xmlhttp.send();
}
</script>
<style>
...
<div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="radio">
                        <label><input type="radio" id="mail" name="forgotpass" onclick="changePassform()">Change Password via email</label>
                    </div>
                    <div class="radio">
                        <label><input type="radio" id="secques" name="forgotpass" onclick="changePassSec()">Change Password via security question</label>
                    </div>
                        <div id="changepass">
                    ...
                    <div class="pull-right">
                        <button type="button" class="btn btn-primary" onclick="goBack()" name="login_page" id="login_page">Go To Login Page</button>
                        </div>
...
//else
//{
//    header("location:login.php?status='This E-Mail ID is NOT registered..'");
//}