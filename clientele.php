  ...
  <button type="submit" class="btn btn-default">Submit</button>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <h1 class="page-header">Clientele</h1>
            </div>

            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://ilpgt.com/">
                    <img class="img-responsive" src="logo/instrumentation_logo.jpg" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.mgvcl.com/">
                    <img class="img-responsive" src="logo/MGVCL.JPG" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.apexengineers.com/">
                    <img class="img-responsive" src="logo/apex_engineers_logo.jpg" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.jtbtours.com/">
                    <img class="img-responsive" src="logo/jtb_logo.jpg" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.mechair.in/">
                    <img class="img-responsive" src="logo/mechair.png" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.globalaviationindia.com/home.html">
                    <img class="img-responsive" src="logo/global.png" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://www.sabchem.com/">
                    <img class="img-responsive" src="logo/sabari.png" height="200" width="200">
                </a>
            </div>
            <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                <a class="thumbnail" href="http://snsvo4.seekandsource.com/sachinamtravels/">
                    <img class="img-responsive" src="logo/sachinam.png" height="200" width="200">
                </a>
            </div>
        </div>
