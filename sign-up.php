...
<html>
	<head>	
		<title>Sign-Up | Sai Enterprise</title>
						  	...
						  	<div class="Regisration-head">
						    	<h2><span></span>Register</h2>
                                                      ...
                                                      <form action="Registration_handler.php" method="post">
                                                          <label style="color: white;">First Name:</label><input type="text" placeholder="First Name" name="fname" id="fname" data-toggle="tooltip" title="Enter alphabets with first letter capital having minimum 4 chars."><br>
                                                          <label style="color: white;">Last Name:</label><input type="text" placeholder="Last Name" name="lname" id="lname" data-toggle="tooltip" title="Enter alphabets with first letter capital having minimum 4 chars."><div id="lastname"></div><br>
                                                          <label style="color: white;">Contact:</label><input type="number" placeholder="Contact" name="contact" id="contact" data-toggle="tooltip" title="Enter only numeric values having minimum 10 and maximum 11 chars."><div id="cont"></div><br>
                                                          <label style="color: white;">Email Address:</label><input type="email" placeholder="Email Address" name="email" id="email" data-toggle="tooltip" title="Enter valid email address having @ and . chars."><div id="email"></div><br>
                                                          <label style="color: white;">Password:</label><input type="password" placeholder="Password" name="password" id="password" data-toggle="tooltip" title="Enter alphanumeric values with minimum 8 chars long."><div id="pass"></div><br>
                                                          <label style="color: white;">Confirm Password:</label><input type="password" placeholder="Confirm Password" name="confirmpass" id="confirmpass" data-toggle="tooltip" title="Write same password as written above."><div id="conf"></div><br>
                                                                <label style="color: white;">Security Question:</label>
                                                                <br>
                                                                <?php
                                    ...
                                    while ($row = mysqli_fetch_array($result,MYSQLI_BOTH)) {
                                        ...
                                        echo "<option value='$i'>$row[0]</option>";
                                                                ...
                                                                <br>
                                                                <label style="color: white;">Answer:</label><input type="text" placeholder="Answer" name="ans"><br>
								 <div class="Remember-me">
								
												 
								<div class="submit">
                                                                    <input type="submit" onclick="myFunction()" id="save1" value="Save and Next" >
...
<!--                        <script src="js/validator_new_user.js"></script>-->
                        <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.11.4/jquery-ui.min.js"></script>
                        <script src="js/jquery.balloon.min.js"></script>

                        <script>
                        $(function() {
                        $('input[type=text], input[type=password], input[type=number], input[type=email]').balloon({position: "right", css: {
    height: '34px',
...
$(document).ready(function() {
    var $submit = $("input[type=submit]"),
        $inputs = $('input[type=text], input[type=password], input[type=number], input[type=email]');
