...
<div class="container">
  ...
  <div class="row">
    <div class="col">
      <h3>General Terms</h3><hr>
      <p>By accessing and placing an order with SaiEnterprise, you confirm that you are in agreement with and bound by the
      terms and conditions contained in the Terms Of Use outlined below. These terms apply to the entire website and any 
      email or other type of communication between you and SaiEnterprise.</p>
    </div>
    </div>
    <div class="row">
    <div class="col">
      <h3>Products</h3><hr>
      <p>All products and services are delivered by SaiEnterprise electronically to your email address.
      SaiEnterprise is not responsible for any technological delays beyond our control. If your spam blocker blocks our emails from reaching you or you do not provide a valid email address where you can be reachable then you can access your download from the Purchases page.</p>
    </div>
    </div>
    <div class="row">
    <div class="col">
      <h3>Security</h3><hr>
      <p>SaiEnterprise does not process any order payments through the website. All payments are processed securely through a third party online payment provider. Feel free to contact us about our security policies.</p>
    </div>
  </div>
  <div class="row">
    <div class="col">
      <h3>Changes to Terms</h3><hr>
